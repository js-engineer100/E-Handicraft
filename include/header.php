            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-11">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="./"> <b class="text-primary">Hand Crafted</b> Store </a>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown_1">
                                        <a class="dropdown-item" href="category.php?cat=Wall"> Wall Decoration</a>
                                        <a class="dropdown-item" href="category.php?cat=Gift"> Gift Item</a>
                                        <a class="dropdown-item" href="category.php?cat=Jewellery"> Jewellery</a>
