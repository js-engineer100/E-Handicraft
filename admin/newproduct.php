              ...
              <div class="box-body">
                ...
                <div class="row">
                  ...
                  <div class="row">
                    ...
                    <label>
                      <input type="radio" name="cat" id="optionsRadios1" value="Wall" checked="">
                      Wall Decoration
                    </label>
                  </div></div>
                  ...
                  <div class="col-md-4"> <div class="radio">
                    <label>
                      <input type="radio" name="cat" id="optionsRadios2" value="Gift">
                      Gift
                    </label>
                  </div></div>
                  ...
                  <div class="col-md-4">  <div class="radio">
                    <label>
                      <input type="radio" name="cat" id="optionsRadios3" value="Jewellery" >
                      Jewellery 
                    </label>
                  </div></div>
